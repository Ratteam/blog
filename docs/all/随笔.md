<TOC />
## error  : 项目的默认 XML 命名空间必须为 MSBuild XML 命名空间。如果项目是用 MSBuild 2003 格式创建的，请将 xmlns="http://schemas.microsoft.com/developer/msbuild/2003" 添加到 
https://social.msdn.microsoft.com/Forums/zh-CN/4c5d6135-4b74-4525-94e2-69b0d6fd15da/vs20132115236733vs201739033304463838239064?forum=2212

## visual studio怎么导入一个工程
https://zhidao.baidu.com/question/457328329.html

## git clone文件较大时报错
https://blog.csdn.net/p_xiaojia/article/details/97689863

## 查看github项目大小
https://api.github.com/repos/Ratteam/godot
...
https://www.cnblogs.com/wesky/p/10101016.html

## phpstudy的php项目在nginx环境下404、403错误
https://blog.csdn.net/qq_29180565/article/details/100803686

## 我的godot开发环境调教记录分享
https://indienova.com/u/yahoohoo/blogread/12104

https://indienova.com/u/yahoohoo/blogread/12327

## PDCA工作法：计划（Plan）、执行（Do）、检查（Check）、调整（Adjust）
